...
const (
	// Label holds the string label denoting the usageevidence type in the database.
	Label = "usage_evidence"
	// FieldID holds the string denoting the id field in the database.
	FieldID = "id"
	// FieldPackageHint holds the string denoting the packagehint field in the database.
	...
	// FieldModuleItem holds the string denoting the moduleitem field in the database.
	FieldModuleItem = "module_item"
	// FieldModuleAlias holds the string denoting the modulealias field in the database.
	FieldModuleAlias = "module_alias"
	// FieldIsWildCardUsage holds the string denoting the iswildcardusage field in the database.
	FieldIsWildCardUsage = "is_wild_card_usage"
	// FieldIdentifier holds the string denoting the identifier field in the database.
	FieldIdentifier = "identifier"
	// FieldUsageFilePath holds the string denoting the usagefilepath field in the database.
...
var (
	// DefaultIsWildCardUsage holds the default value on creation for the "IsWildCardUsage" field.
	DefaultIsWildCardUsage bool
)

// OrderOption defines the ordering options for the UsageEvidence queries.
...
// ByUsageFilePath orders the results by the UsageFilePath field.
