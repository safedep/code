...
func (cip *ComputedInheritanceProcessor) storeComputedRelationship(childName, ancestorName string,
	depth int, projectID int) error {
...
func (cip *ComputedInheritanceProcessor) ComputeProjectStatistics(projectID int, globalGraph *ast.InheritanceGraph) (map[string]any, error) {
	allClasses := globalGraph.GetAllClasses()
