...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			astnode.Table:                 astnode.ValidColumn,
			callrelationship.Table:        callrelationship.ValidColumn,
			file.Table:                    file.ValidColumn,
			importstatement.Table:         importstatement.ValidColumn,
			inheritancerelationship.Table: inheritancerelationship.ValidColumn,
			project.Table:                 project.ValidColumn,
			symbol.Table:                  symbol.ValidColumn,
			symbolreference.Table:         symbolreference.ValidColumn,
		})
	})
