...
var testcases = []DepsTestcase{
	{
		...
		ExpectedEvicences: []*UsageEvidence{
			newUsageEvidence("", "seaborn", "", "", true, "*", "fixtures/testcases.py", 60),
			newUsageEvidence("", "flask.helpers", "", "", true, "*", "fixtures/testcases.py", 61),
			newUsageEvidence("", "xyz.pqr.mno", "", "", true, "*", "fixtures/testcases.py", 62),
			newUsageEvidence("", "sys", "", "sys", false, "sys", "fixtures/testcases.py", 6),
			newUsageEvidence("", "math", "sqrt", "sqrt", false, "sqrt", "fixtures/testcases.py", 13),
			newUsageEvidence("", "pandas", "", "pd", false, "pd", "fixtures/testcases.py", 18),
			newUsageEvidence("", "matplotlib.pyplot", "", "plt", false, "plt", "fixtures/testcases.py", 22),
			newUsageEvidence("", "slumber", "API", "sl", false, "sl", "fixtures/testcases.py", 27),
			newUsageEvidence("", "sklearn", "datasets", "ds", false, "ds", "fixtures/testcases.py", 29),
			newUsageEvidence("", "sklearn", "metrics", "met", false, "met", "fixtures/testcases.py", 30),
			newUsageEvidence("", "random", "randint", "randint", false, "randint", "fixtures/testcases.py", 35),
			newUsageEvidence("", "collections", "deque", "deque", false, "deque", "fixtures/testcases.py", 37),
			newUsageEvidence("", "collections", "defaultdict", "defaultdict", false, "defaultdict", "fixtures/testcases.py", 39),
			newUsageEvidence("", "collections", "namedtuple", "namedtuple", false, "namedtuple", "fixtures/testcases.py", 40),
			newUsageEvidence("", "json.encoder.implementation", "JSONEncoder", "JSONEncoder", false, "JSONEncoder", "fixtures/testcases.py", 46),
			newUsageEvidence("", "urllib.parse", "urlsplit", "urlsplit", false, "urlsplit", "fixtures/testcases.py", 47),
			newUsageEvidence("", "ujson", "", "ujson", false, "ujson", "fixtures/testcases.py", 52),
			newUsageEvidence("", "simplejson", "", "smpjson", false, "smpjson", "fixtures/testcases.py", 56),
		},
	},
}
